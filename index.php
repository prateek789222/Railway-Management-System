	...
	<div class="wrap">
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				...
				<a class="brand" href="query1.php">USERNAME BOOKED</a>
				<a class="brand" href="query2.php">TRAIN ON DAY</a>
				<a class="brand" href="query3.php">WAITING STATUS OF ALL</a>
				<a class="brand" href="query4.php">TICKET BOOKED TODAY</a>
		...
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="active item"><img src="images/i1.jpg" style="width:600px;height:350px;"/></div>
			...
			<!-- <marquee behavior="scroll" id="marq"  scrollamount=3 direction="up" height="294px" onmouseover="nestop()" onmouseout="nestrt()"> -->
				<div>
				<p><b>PROJECT CREATED BY PRATEEK SOURAV 1BG20AI106</b></p>
				</br>
				<!-- <p><b>SUBMITTED AS A PART OF DBMS MINI PROJECT</b></p></br> -->
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">  &copy; PRATEEK DBMS PROJECT 18CSL58.</p>	
			</div>
			<div style="float:right;">
			<p class="text-right text-info">	Made by: PRATEEK SOURAV  USN: 1BG20AI106</p>
			</div>
		</div>
		</footer>	</div>
